      ...
      <div className="flex h-full bg-gray-50">
        ...
        <div className="w-64 border-r border-gray-200 p-4 bg-white">
          <div className="flex items-center space-x-2 mb-6">
            ...
            <h2 className="font-semibold text-gray-800">Work Timeline</h2>
          </div>
          <div className="space-y-2">
            <div className="text-sm text-gray-600">2024 - Present</div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center space-x-3">
                    ...
                    />
                    <h3 className="text-xl font-semibold text-gray-800">Think41</h3>
                  </div>
                  <p className="text-blue-600 font-medium mt-1">Software Development Engineer 1</p>
                  <p className="text-gray-600 text-sm mt-1">July 2023 - Present</p>
                </div>
              </div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center space-x-3">
                    ...
                    />
                    <h3 className="text-xl font-semibold text-gray-800">Nokia Networks</h3>
                  </div>
                  <p className="text-blue-600 font-medium mt-1">Software Engineering Intern</p>
                  <p className="text-gray-600 text-sm mt-1">Aug 2023 - June 2024</p>
                </div>
              </div>
              <div className="mt-4 text-gray-700">
                <ul className="list-disc pl-5 space-y-2">
